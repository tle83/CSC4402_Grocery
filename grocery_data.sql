...
insert into Item values ('S1', 'I004', 'Eggs', 3.25);
insert into Item values ('S1', 'I005', 'Yogurt', 3.00);
insert into Item values ('S1', 'I006', 'Orange Juice', 2.50);
insert into Item values ('S1', 'I007', 'Coke', 1.25);
insert into Item values ('S1', 'I008', 'Sprite', 1.25);
insert into Item values ('S1', 'I009', 'Doritos', 1.00);
insert into Item values ('S1', 'I010', 'Cheetos', 1.00);
insert into Item values ('S1', 'I011', 'Hersheys', 1.00);
insert into Item values ('S1', 'I012', 'Onions', 1.75);
insert into Item values ('S1', 'I013', 'Garlic', 1.50);
insert into Item values ('S1', 'I014', 'Lettuce', 1.25);
insert into Item values ('S1', 'I015', 'Orange', 2.25);
insert into Item values ('S1', 'I016', 'Cherries', 2.25);
insert into Item values ('S1', 'I017', 'Pineapple', 3.25);
insert into Item values ('S1', 'I018', 'Cereal', 2.00);
insert into Item values ('S1', 'I019', 'Flour', 1.75);
insert into Item values ('S1', 'I020', 'Bread', 1.75);
insert into Item values ('S1', 'I021', 'Ice Cream', 1.50);
insert into Item values ('S1', 'I022', 'Pizza', 5.00);
insert into Item values ('S1', 'I023', 'Cookies', 2.50);
insert into Item values ('S1', 'I024', 'Cooking oil', 3.00);
